...
class LILAC(Implosion):
    ...
    def __init__(self, type='GUI', args='', wm=None):
        ...
        if type is 'GUI':
            ...
            FILEOPENOPTIONS = dict(defaultextension='.e*',
                           filetypes=[('reduced LILAC','*.lilac'),
                                      ('LILAC','*.e*')],
                           multiple=False)
    ...
    def getFileTypes(cls):
        ...
        Must be an array of dicts ready to pass to file dialog, e.g.::
            ...
            [('description', '*.ext')]
        """
        return [('reduced LILAC','*.lilac'),('LILAC','*.e*')]
    ...
    def generate(self):
        ...
        print("Begining generating implosion:  ")
        self.runProgress = 0.
    ...
    def find_next_num(self, L, ii=0):
        ...
        :return: the first str that can be intepreted as a number, cast as a number
        """
        for item in L[ii:]:
            try:
                return float(item)
    ...
    def __read_LILAC__(self):
        ...
        print( "we get to __read_LILAC__  yay!!")
    ...
    def lilac_full_parse_time_step(self,dataReader):
        ...
        while True:
            ...
            # get the time.  we want to store the time in s
            ...
            # we terminate (at the end of the time block)
    ...
    def lilac_full_parse_pellet_info(self,dataReader):
        ...
        while True:
            ...
            # all layers info start with an integer or some sort
                ...
                # if this is the begining of a new layer
